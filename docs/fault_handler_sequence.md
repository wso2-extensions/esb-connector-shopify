# Configuring the Shopify Fault Handler Sequence

Following is a sample proxy service and fault handler sequence that you can use as a starting point for handling faults when integrating with Shopify. You can customize this sample based on your requirement.

**Sample Proxy**
```xml
<proxy xmlns="http://ws.apache.org/ns/synapse" name="Shopify_sampleProxy" transports="https,http" statistics="disable" trace="disable" startOnLoad="true">
  <target>
